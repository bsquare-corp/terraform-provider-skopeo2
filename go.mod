...
require (
	github.com/bsquare-corp/terraform-provider-skopeo v0.1.2
...
replace github.com/containers/image/v5 => github.com/bsquare-corp/image/v5 v5.0.0-20230109143143-f6f6072f5259
